	...
	<div class="about">
		<div class="w3_agileits_contact_grids">
			...
			<div class="col-md-6 w3_agileits_contact_grid_right">
				<h2 class="w3_agile_header">留下讯息</h2>
				...
				<form action="#" method="post">
					...
					<textarea name="Message" placeholder="写下您的留言..." required=""></textarea>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>纽约市第4街区1234 K大道</li>
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="short-codes.jsp">短码</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="faq.jsp">常见问题</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="products.jsp">特殊产品</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>分类</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="groceries.jsp">杂货</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="household.jsp">家庭</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="personalcare.jsp">个人护理</a></li>
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>其他</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="products.jsp">商店</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="checkout.jsp">我的购物车</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="login.jsp">登录</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="registered.jsp">创建账户</a></li>
					</ul>
