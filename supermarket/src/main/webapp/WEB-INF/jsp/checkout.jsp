	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1">
				<li><a href="index.jsp"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>页面</a></li>
				<li class="active">付款通道</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<div class="container">
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					<h4>继续添加至购物车</h4>
					<ul>
						<li>物品1 <i>-</i> <span>$15.00 </span></li>
						<li>物品2 <i>-</i> <span>$25.00 </span></li>
						<li>物品3 <i>-</i> <span>$29.00 </span></li>
						<li>总服务费用 <i>-</i> <span>$15.00</span></li>
						<li>合计 <i>-</i> <span>$84.00</span></li>
					</ul>
				</div>
				<div class="checkout-right-basket">
					<a href="single.jsp"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>继续购物</a>
				</div>
